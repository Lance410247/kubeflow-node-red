...
-->
<script type="text/x-red" data-template-name="bagging">
  <div class="form-tips"><p>Provide a python file with full path</p>
  
  <div class="form-row">
    <label for="node-input-name"><i class="fa fa-tag"></i> Name </label>
    <input type="text" id="node-input-name" value="/data/1.connect-kubeflow/py/bagging.py" readonly>
  </div>
  <div class="form-row">
...
<script type="text/x-red" data-help-name="bagging">
...
<script type="text/javascript">
  ...
  RED.nodes.registerType('bagging',{
    category: 'input',
    defaults: {
      name: {required: false},
      pyfile: {value:"/data/1.connect-kubeflow/py/bagging.py"},
